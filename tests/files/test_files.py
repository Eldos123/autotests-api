...
class TestFiles:
    def test_create_file(self, files_client: FilesClient):
        """
        Тест проверяет создание файла через API.
        """
...
class TestFiles:
    def test_get_file(self, files_client: FilesClient, function_file: FileFixture):
        """
        Тест проверяет получение файла по его ID.
        """
...
class TestFiles:
    ...
    def test_create_file_with_empty_filename(self, files_client: FilesClient):
        """
        тест проверяет создание файла с пустым именем файла.
        """
    ...
    def test_create_file_with_empty_directory(self, files_client: FilesClient):
        """
        Тест проверяет создание файла с пустой директорией.
        """
        request = CreateFileRequestSchema(
            directory="",
            upload_file="./testdata/files/image.png"
...
class TestFiles:
    def test_delete_file(self, files_client: FilesClient, function_file: FileFixture):
        """
        Тест проверяет удаление файла и последующую попытку его получения.
        """
        # 1. Удаляем файл
    ...
    def test_get_file_with_incorrect_file_id(self, files_client: FilesClient):
        """
        Тест проверяет получение файла с некорректным file_id.
        """
